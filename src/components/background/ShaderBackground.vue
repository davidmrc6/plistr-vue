...
<template>
  <div class="fixed inset-0 z-0">
    <!-- base gradient -->
    <div
      class="absolute inset-0 bg-gradient-to-br from-violet-50 via-blue-50 to-emerald-50"
    />
    <!-- mesh gradients -->
    <div class="absolute inset-0 opacity-30">
      <div
        class="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-violet-200/40 via-transparent to-blue-200/40 animate-mesh-flow-1"
      />
      <div
        class="absolute top-0 right-0 w-full h-full bg-gradient-to-bl from-blue-200/40 via-transparent to-emerald-200/40 animate-mesh-flow-2"
      />
      <div
        class="absolute bottom-0 left-0 w-full h-full bg-gradient-to-tr from-emerald-200/40 via-transparent to-violet-200/40 animate-mesh-flow-3"
      />
    </div>
    ...
    <div class="absolute inset-0 opacity-30">
      <div
        class="absolute inset-0 bg-gradient-radial from-violet-100/20 via-transparent to-transparent animate-pulse-slow"
      />
      <div
        class="absolute inset-0 bg-gradient-conic from-blue-100/20 via-transparent to-emerald-100/20 animate-spin-very-slow"
      />
    </div>
  </div>
</template>
